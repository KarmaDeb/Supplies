...
/**
 * <b>SoundFixer</b> - Universal Minecraft Sound Support<br>
...
public enum SoundFixer {
    ...
    /**
     * An immutable cached list of {@link SoundFixer#values()} to avoid allocating memory for
     * calling the method every time.
     *
     * @since 2.0.0
     */
    public static final EnumSet<SoundFixer> VALUES = EnumSet.allOf(SoundFixer.class);
    /**
     ...
     * @since 2.0.0
     */
    private static final Cache<SoundFixer, com.google.common.base.Optional<Sound>> CACHE = CacheBuilder.newBuilder()
    ...
    /**
     * Checks if SoundFixer enum and the legacy names contains a sound with this name.
     *
     * @param sound name of the sound
     * @return true if SoundFixer enum has this sound.
     * @since 1.0.0
     */
    public static boolean contains(@Nonnull String sound) {
        ...
        for (SoundFixer sounds : VALUES)
            if (sounds.name().equals(sound) || sounds.anyMatchLegacy(sound)) return true;
        return false;
    }

    /**
     * Parses the SoundFixer with the given name.
     *
     * @param sound the name of the sound.
     * @return a matched SoundFixer.
     * @since 1.0.0
     */
    @Nonnull
    public static Optional<SoundFixer> matchSoundFixer(@Nonnull String sound) {
        Validate.notEmpty(sound, "Cannot match SoundFixer of a null or empty sound name");
        sound = format(sound);
    ...
    /**
     * Parses the SoundFixer with the given bukkit sound.
     *
     ...
     */
    @Nonnull
    public static SoundFixer matchSoundFixer(@Nonnull Sound sound) {
        Objects.requireNonNull(sound, "Cannot match SoundFixer of a null sound");
        return matchSoundFixer(sound.name())
    ...
    public static CompletableFuture<Void> playSoundFromString(@Nonnull Player player, @Nullable String sound) {
        ...
        return CompletableFuture.runAsync(() -> {
            ...
            String name = split[0];
            Optional<SoundFixer> typeOpt = matchSoundFixer(name);
    ...
    /**
     * Parses the SoundFixer as a {@link Sound} based on the server version.
     *
